...
--
-- Host: localhost    Database: ceres_prod
-- ------------------------------------------------------
...
CREATE TABLE `alerts` (
  ...
  `show_before` datetime NOT NULL,
  `created_at` datetime DEFAULT NULL,
  `updated_at` datetime DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `index_alerts_on_show_after` (`show_after`),
  KEY `index_alerts_on_show_before` (`show_before`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `coupons` (
  ...
  `product_filter_type` varchar(255) DEFAULT NULL,
  `product_filter_targets` text,
...
CREATE TABLE `delivery_destinations` (
  ...
  `member_directions` varchar(512) DEFAULT NULL,
  `driver_directions` text,
  ...
  `fuzzy_lat` varchar(255) DEFAULT NULL,
  `fuzzy_lng` varchar(255) DEFAULT NULL,
  PRIMARY KEY (`id`),
...
--
-- Table structure for table `food_hosts`
--

DROP TABLE IF EXISTS `food_hosts`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `food_hosts` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(255) DEFAULT NULL,
  `delivery_run_id` int(11) DEFAULT NULL,
  `address_line_1` varchar(255) DEFAULT NULL,
  ...
  `max_active_users` int(11) DEFAULT NULL,
  `host_id` int(11) DEFAULT NULL,
  `cached_member_count` int(11) NOT NULL DEFAULT '0',
  `cached_active_member_count` int(11) NOT NULL DEFAULT '0',
  `driver_notes` text,
  PRIMARY KEY (`id`),
  KEY `index_delivery_locations_on_host_id` (`host_id`),
  KEY `index_delivery_locations_on_lat_and_lng` (`lat`,`lng`),
...
--
-- Dumping data for table `food_hosts`
--

LOCK TABLES `food_hosts` WRITE;
/*!40000 ALTER TABLE `food_hosts` DISABLE KEYS */;
/*!40000 ALTER TABLE `food_hosts` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `notifications` (
  ...
  `updated_at` datetime DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `index_notifications_on_alert_id` (`alert_id`),
...
CREATE TABLE `orders` (
  ...
  `product_id` int(11) DEFAULT NULL,
  `user_id` int(11) DEFAULT NULL,
  `delivery_week` date DEFAULT NULL,
  ...
  `deleted_at` datetime DEFAULT NULL,
  `delivery_fee` decimal(8,2) NOT NULL DEFAULT '0.00',
  `delivery_date_cached` date DEFAULT NULL,
  PRIMARY KEY (`id`),
  ...
  KEY `index_orders_on_delivery_week` (`delivery_week`),
...
CREATE TABLE `product_types` (
  ...
  `ancestry_string` varchar(128) DEFAULT NULL,
...
CREATE TABLE `products` (
  ...
  `out_of_stock_message` varchar(255) DEFAULT NULL,
  `hide_when_out_of_stock` tinyint(1) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`),
...
--
-- Table structure for table `public_holiday_weeks`
--

DROP TABLE IF EXISTS `public_holiday_weeks`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `public_holiday_weeks` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(255) DEFAULT NULL,
  `holiday_week` date DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `public_holiday_weeks`
--

LOCK TABLES `public_holiday_weeks` WRITE;
/*!40000 ALTER TABLE `public_holiday_weeks` DISABLE KEYS */;
/*!40000 ALTER TABLE `public_holiday_weeks` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `suppliers` (
  ...
  `created_at` datetime DEFAULT NULL,
  `updated_at` datetime DEFAULT NULL,
  `owners` varchar(64) DEFAULT NULL,
  `suburb` varchar(64) DEFAULT NULL,
  `produce` varchar(64) DEFAULT NULL,
  ...
  `interview` text,
  `interview_image_file_name` varchar(255) DEFAULT NULL,
  `interview_image_content_type` varchar(128) DEFAULT NULL,
...
--
-- Table structure for table `trials_users`
--
...
CREATE TABLE `trials_users` (
  ...
  KEY `index_trials_users_on_trial_id` (`trial_id`),
  KEY `index_trials_users_on_user_id` (`user_id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `trials_users`
--

LOCK TABLES `trials_users` WRITE;
/*!40000 ALTER TABLE `trials_users` DISABLE KEYS */;
/*!40000 ALTER TABLE `trials_users` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `users` (
  ...
  `cc_tail` varchar(4) DEFAULT NULL,
  ...
  `referral_credit_paid` tinyint(1) NOT NULL DEFAULT '0',
  `full_name` varchar(128) NOT NULL,
  `useragent` varchar(255) DEFAULT NULL,
  `last_reminder_at` datetime DEFAULT NULL,
  `driver_directions` varchar(255) DEFAULT NULL,
  `is_active` tinyint(1) DEFAULT '1',
  `receives_newsletter` tinyint(1) DEFAULT '1',
  `receives_promotions` tinyint(1) DEFAULT '1',
  PRIMARY KEY (`id`),
  UNIQUE KEY `index_users_on_referral_code` (`referral_code`),
  ...
  KEY `index_users_on_referral_credit_paid` (`referral_credit_paid`),
  KEY `index_users_on_referred_by_id` (`referred_by_id`),
...
-- Dump completed on 2016-10-29  1:26:01
